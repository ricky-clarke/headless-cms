...
export default function Team ( props  ) { 
    ...
    const { spacing } = props.data

    const { data: users, isLoading, isError: error, } = useSWR(`${process.env.NEXT_PUBLIC_HEADLESS}team`, fetcher, { revalidateOnFocus: false, revalidateOnReconnect: false, revalidateIfStale: false }
    );
    ...
    return (
             <section className={`${styles.module__team} module ${spacing}`}>
